<footer class="border-2 border-gray-200 dark:border-gray-700 bg-blue-100 dark:bg-gray-800 sm:p-10">
    <div class="mx-auto max-w-screen-xl text-center">
        ...
        <ul class="mb-6 flex flex-wrap items-center justify-center text-gray-900 dark:text-white">
            <li>
                <a class="mx-2 hover:underline md:mx-3" href="{{ route('frontend.aboutus') }}"
                    wire:navigate.hover>@lang('About')</a>
            </li>
            <li>
            ...
            <li>
                <a class="mx-2 hover:underline md:mx-3" href="{{ route('frontend.contact') }}"
                    wire:navigate.hover>@lang('Contact')</a>
            </li>
        </ul>
