<nav
    class="border-2 border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900 sticky top-0 z-50 transition-all duration-300">
    <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
        ...
        <button
            ...
            data-collapse-toggle="navbar-language" type="button" aria-controls="navbar-language" aria-expanded="false">
        ...
        <div class="hidden w-full items-center justify-between md:order-1 md:flex md:w-auto" id="navbar-language">
            <ul
                ...
                <x-frontend.nav-item-dropdown :active="request()->routeIs('frontend.aboutus') || request()->routeIs('frontend.partnership')" title="{{ __('About') }}">
                    <div
                        class="px-7 py-4 text-sm text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                ...
                <x-frontend.nav-item-dropdown :active="request()->routeIs('frontend.medicalcares.index') ||
                    request()->routeIs('frontend.medicalpoints.index') ||
                    request()->routeIs('frontend.medicalcenters.index') ||
                    request()->routeIs('frontend.medicalcosts.index') ||
                    request()->routeIs('frontend.medicalalters.index') ||
                    request()->routeIs('frontend.medicaleducation.index')" title="{{ __('Services') }}">
                    <div
                        class="px-7 py-4 text-sm text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
        ...
        <div class="flex items-center space-x-3 md:order-2">
            ...
            @auth
                <button
                    ...
                    <img class="h-9 w-9 rounded-full object-cover bg-gray-100" src="{{ asset(Auth::user()->avatar) }}"
                        alt="">
                    <span class="ms-2 hidden sm:block">
                        {{ Auth::user()->last_name }}
                    </span>
