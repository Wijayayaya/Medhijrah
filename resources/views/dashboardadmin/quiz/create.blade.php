...
@section('title', 'Tambah Quiz - Medical Services')
@section('page-title', 'Tambah Quiz')
@section('page-description', 'Buat pertanyaan quiz baru')
...
<li>
    <div class="flex items-center">
        <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
        <span class="text-gray-500">Tambah Quiz</span>
    </div>
</li>
@endsection
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">Buat pertanyaan quiz untuk edukasi kesehatan</p>
        </div>

        <!-- Form -->
        <form action="{{ route('dashboardadmin.quiz.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="mb-6">
                ...
                <textarea name="question" id="question" rows="3" 
                          ...
                          placeholder="Masukkan pertanyaan quiz...">{{ old('question') }}</textarea>
                @error('question')
            ...
            <div class="mb-6">
                ...
                <textarea name="explanation" id="explanation" rows="4" 
                          ...
                          placeholder="Berikan penjelasan mengapa jawaban tersebut benar...">{{ old('explanation') }}</textarea>
                @error('explanation')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
