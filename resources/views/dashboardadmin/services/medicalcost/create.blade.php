...
@section('title', 'Medical Cost - Create')
@section('page-title', 'Add New Medical Cost')
@section('page-description', 'Create a new medical service cost entry')
    ...
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Add New Medical Cost</h1>
                    <p class="text-sm text-gray-500">Create a new medical service cost entry</p>
                </div>
            </div>
        </div>

        <!-- Form -->
        <form action="{{ route('dashboardadmin.services.medicalcost.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-center space-x-2">
                    <span class="text-lg font-semibold text-green-600" id="preview-lowest">Rp 0</span>
                    <span class="text-gray-500">-</span>
                    <span class="text-lg font-semibold text-red-600" id="preview-highest">Rp 0</span>
                </div>
            ...
            <div class="flex items-center justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Save Medical Cost
                </button>
            </div>
        </form>
    </div>
