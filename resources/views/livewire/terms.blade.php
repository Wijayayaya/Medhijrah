    ...
    <section class="mx-auto max-w-screen-xl bg-white p-6 text-gray-600 sm:p-20">
        <div class="grid grid-cols-1">
            ...
            <p>
                ...
                Website, located at <a href="{{ config('app.url') }}">{{ config('app.url') }}</a>.
            </p>
            <p>
            ...
            <p>
                ...
                this from {{ app_name() }} for your own personal use subjected to restrictions set in these terms
                and
                conditions.
            </p>
            <h3 class="mb-2 mt-4 text-2xl">
